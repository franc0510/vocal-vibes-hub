-- ============================================================
--  VocMe — le code de partage et le lien d'invitation des GROUPES
-- ============================================================
--
--  À COLLER DANS : tableau de bord Supabase → SQL Editor → Run
--
--  Ce fichier reprend la migration :
--    supabase/migrations/20260908100000_group_invite_codes.sql
--
...
--  contre un vrai Postgres, avec 23 assertions sur les règles d'accès des
--  groupes.
--
--  SANS LUI, la feuille de partage affiche « This group has no share code
--  yet » et « Join with a code » répond en erreur : la colonne join_code et
--  les deux fonctions n'existent tout simplement pas en base.
--
--  APRÈS L'AVOIR PASSÉ, il n'y a rien d'autre à faire : les groupes déjà
--  créés reçoivent leur code dans le même passage. Recharger l'application
--  suffit à le voir.
-- ============================================================
