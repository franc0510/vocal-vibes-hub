-- ============================================================
--  VocMe — le moteur de défis, et le tuyau des notifications
-- ============================================================
--
--  À COLLER DANS : tableau de bord Supabase → SQL Editor → Run
--
--  Concaténation des six migrations du moteur :
--    20260901100000_competitions.sql
--    20260901110000_competition_notification_types.sql
--    20260902100000_competition_vote_and_clock.sql
--    20260903100000_competition_join_lock.sql
--    20260904100000_competition_invite_preview.sql
--    20260905100000_push_and_awards.sql
--
--  Idempotent : le relancer ne casse rien et ne perd aucune donnée. Rejoué de
--  zéro contre un vrai Postgres, avec 63 assertions sur les règles d'accès.
--
--  ⚠ LA DERNIÈRE PARTIE dépend de `pg_net`, qui n'existe que sur Supabase.
--  Le déclencheur d'envoi ne s'installe QUE si l'extension est présente : si
--  tu actives `pg_net` après coup (Database → Extensions), REPASSE ce fichier
--  pour que le pont s'installe enfin. Voir PUSH_NOTIFICATIONS_SETUP.md.
--
