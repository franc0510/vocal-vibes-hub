...
--
--  Ce fichier est la concaténation des trois migrations :
...
--  contre un vrai Postgres, avec 33 assertions sur les règles d'accès.
--
...
--  la bonne manœuvre : la troisième partie remplace les règles qui laissaient
--  un défi démarrant le jour même sans aucun jour, le verrou d'équipe sans
--  effet, et le vote sans écran ni dépouillement.
--
