...
--
--  Ce fichier est la concaténation des quatre migrations :
...
--  contre un vrai Postgres, avec 43 assertions sur les règles d'accès.
--
...
--  la bonne manœuvre. La quatrième partie, en particulier, pose le verrou
--  d'équipe au moment de rejoindre et donne un code d'invitation à toutes les
--  compétitions, y compris celles déjà créées sans code.
--
