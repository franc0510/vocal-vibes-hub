...
#ifndef MEDIAPLUGIN_SWIFT_H
#define MEDIAPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MediaPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("MediaPlugin")
@interface MediaPlugin : CAPPlugin <CAPBridgedPlugin>
